		...
		uint8_t					expected_value)
{
	...
	do {
		status |= vl53l7cx_readMulti(&(p_dev->platform), address,
              ...
              VL53L7CX_Configuration      *p_dev)
{
   ...
   do {
		status |= vl53l7cx_readByte(&(p_dev->platform), 0x06, &go2_status0);
		if((go2_status0 & (uint8_t)0x80) != (uint8_t)0){
			status |= vl53l7cx_readByte(&(p_dev->platform), 0x07, &go2_status1);
			status |= go2_status1;
			break;
		}
		...
		uint8_t						resolution)
{
	...
	status |= vl53l7cx_writeMulti(&(p_dev->platform), 0x2e18, p_dev->temp_buffer,
		...
		uint8_t				resolution)
{
	...
	status |= vl53l7cx_writeMulti(&(p_dev->platform), 0x2cf8,
		...
		uint8_t				*p_is_alive)
{
	...
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7fff, 0x00);
	status |= vl53l7cx_readByte(&(p_dev->platform), 0, &device_id);
	status |= vl53l7cx_readByte(&(p_dev->platform), 1, &revision_id);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7fff, 0x02);
		...
		VL53L7CX_Configuration		*p_dev)
{
	...
	/* SW reboot sequence */
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7fff, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x0009, 0x04);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x000F, 0x40);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x000A, 0x03);
	status |= vl53l7cx_readByte(&(p_dev->platform), 0x7FFF, &tmp);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x000C, 0x01);

	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x0101, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x0102, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x010A, 0x01);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x4002, 0x01);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x4002, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x010A, 0x03);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x0103, 0x01);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x000C, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x000F, 0x43);
	status |= vl53l7cx_waitMs(&(p_dev->platform), 1);

	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x000F, 0x40);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x000A, 0x01);
	...
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x000E, 0x01);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7fff, 0x02);

	/* Enable FW access */
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x03, 0x0D);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7fff, 0x01);
	status |= _vl53l7cx_poll_for_answer(p_dev, 1, 0, 0x21, 0x10, 0x10);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7fff, 0x00);

	/* Enable host access to GO1 */
	status |= vl53l7cx_readByte(&(p_dev->platform), 0x7fff, &tmp);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x0C, 0x01);

	/* Power ON status */
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7fff, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x101, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x102, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x010A, 0x01);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x4002, 0x01);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x4002, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x010A, 0x03);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x103, 0x01);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x400F, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x21A, 0x43);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x21A, 0x03);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x21A, 0x01);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x21A, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x219, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x21B, 0x00);

	/* Wake up MCU */
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7fff, 0x00);
	status |= vl53l7cx_readByte(&(p_dev->platform), 0x7fff, &tmp);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x0C, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7fff, 0x01);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x20, 0x07);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x20, 0x06);

	/* Download FW into VL53L7CX */
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7fff, 0x09);
	status |= vl53l7cx_writeMulti(&(p_dev->platform),0,
		(uint8_t*)&VL53L7CX_FIRMWARE[0],0x8000);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7fff, 0x0a);
	status |= vl53l7cx_writeMulti(&(p_dev->platform),0,
		(uint8_t*)&VL53L7CX_FIRMWARE[0x8000],0x8000);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7fff, 0x0b);
	status |= vl53l7cx_writeMulti(&(p_dev->platform),0,
	...
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7FFF, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x114, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x115, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x116, 0x42);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x117, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x0B, 0x00);
	status |= vl53l7cx_readByte(&(p_dev->platform), 0x7fff, &tmp);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x0C, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x0B, 0x01);
	...
	status |= vl53l7cx_writeMulti(&(p_dev->platform), 0x2fd8,
	...
	status |= vl53l7cx_readMulti(&(p_dev->platform), VL53L7CX_UI_CMD_START,
	...
	status |= vl53l7cx_writeMulti(&(p_dev->platform), 0x2c34,
		...
		uint16_t		        i2c_address)
{
	...
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7fff, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x4, (uint8_t)(i2c_address >> 1));
		...
		uint8_t				*p_power_mode)
{
	...
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7FFF, 0x00);
	status |= vl53l7cx_readByte(&(p_dev->platform), 0x009, &tmp);
		...
		uint8_t			        power_mode)
{
	...
	switch(power_mode)
	{
		case VL53L7CX_POWER_MODE_WAKEUP:
			status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7FFF, 0x00);
			status |= vl53l7cx_writeByte(&(p_dev->platform), 0x09, 0x04);
		...
		case VL53L7CX_POWER_MODE_SLEEP:
			status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7FFF, 0x00);
			status |= vl53l7cx_writeByte(&(p_dev->platform), 0x09, 0x02);
			status |= _vl53l7cx_poll_for_answer(
		...
		VL53L7CX_Configuration		*p_dev)
{
	...
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7fff, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x09, 0x05);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7fff, 0x02);

	/* Start ranging session */
	status |= vl53l7cx_writeMulti(&(p_dev->platform), VL53L7CX_UI_CMD_END -
		...
		VL53L7CX_Configuration		*p_dev)
{
	...
	status |= vl53l7cx_readMulti(&(p_dev->platform),
		...
		&& (p_dev->is_auto_stop_enabled == (uint8_t)1))
	{
	        ...
	        /* Provoke MCU stop */
	        status |= vl53l7cx_writeByte(&(p_dev->platform), 0x15, 0x16);
	        status |= vl53l7cx_writeByte(&(p_dev->platform), 0x14, 0x01);

	        /* Poll for G02 status 0 MCU stop */
	        while(((tmp & (uint8_t)0x80) >> 7) == (uint8_t)0x00)
	        {
	        	status |= vl53l7cx_readByte(&(p_dev->platform), 0x6, &tmp);
	        	status |= vl53l7cx_waitMs(&(p_dev->platform), 10);
	...
	if((tmp & (uint8_t)0x80) != (uint8_t)0){
		status |= vl53l7cx_readByte(&(p_dev->platform), 0x7, &tmp);
	...
	/* Undo MCU stop */
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x7fff, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x14, 0x00);
	status |= vl53l7cx_writeByte(&(p_dev->platform), 0x15, 0x00);
		...
		uint8_t				*p_isReady)
{
	...
	status |= vl53l7cx_readMulti(&(p_dev->platform), 0x0, p_dev->temp_buffer, 4);
		...
		VL53L7CX_ResultsData		*p_results)
{
	...
	union Block_header *bh_ptr;
	uint32_t i, j, msize;
	status |= vl53l7cx_readMulti(&(p_dev->platform), 0x0,
		...
		uint16_t			data_size)
{
	...
	/* Request data reading from FW */
		status |= vl53l7cx_writeMulti(&(p_dev->platform),
		...
		uint16_t			data_size)
{
	...
	/* Send data to FW */
		status |= vl53l7cx_writeMulti(&(p_dev->platform),address,
			p_dev->temp_buffer,
